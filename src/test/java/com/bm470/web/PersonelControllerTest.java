...
public  class PersonelControllerTest {
    ...
    public void personelGuncelle() {
        ...
        String viewFile = personelController.personelGuncelle(14L,model);
    ...
    public void personelSil() {
        String response = personelController.personelSil(14L);
        JSONObject jsonObject = JSONObject.fromObject(response);
        Boolean exist = (Boolean) jsonObject.get("exist");
        Assert.assertTrue(exist);
    }
    ...
    public void personelTcKontrol() {
        String response = personelController.personelTcKontrol(54452193384L);
        JSONObject jsonObject = JSONObject.fromObject(response);
        Boolean exist = (Boolean) jsonObject.get("exist");
        Assert.assertTrue(exist);
    }
